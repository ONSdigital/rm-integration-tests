...
@CucumberOptions(
        features = {"classpath:uk/gov/ons/ctp/follow/up/fieldVisit.feature"},
        ...
        plugin = {"pretty", "html:build/fieldVisit-cucumber-html-report", "json:build/jenkins/fieldVisit.json"}
)
