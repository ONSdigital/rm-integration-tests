...
@CucumberOptions(
        features = {"classpath:uk/gov/ons/ctp/additional/response/individual/indPaperResponse.feature"},
        ...
        plugin = {"pretty", "html:build/indPaperResponse-cucumber-html-report",
            "json:build/jenkins/indPaperResponse.json"}
)
public class IndPaperResponseTest {
