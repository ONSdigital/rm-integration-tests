...
public class ActionExporterResponseAware {
   ...
   */
  public void invokeActionExporterEndpoint(String filter) throws IOException, AuthenticationException {
    final String url = String.format("/actionrequests%s", filter);
