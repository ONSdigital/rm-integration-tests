...
public class ActionExporterSteps {
   ...
   * Constructor
   *
   * @param actionExportResponseAware SFTP runner
   */
  public ActionExporterSteps(ActionExporterSFTPResponseAware actionExportResponseAware) {
    this.responseAware = actionExportResponseAware;
  }
