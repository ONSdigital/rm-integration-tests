...
@CucumberOptions(features = { "classpath:uk/gov/ons/ctp/ui/ReportMI/listReportsForReportType.feature" },
        ...
        "json:build/jenkins/reportslist.json"})

public class ListReportsForReportTypeTest {
