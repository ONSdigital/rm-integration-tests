...
Feature: Validating categories requests
	...
	Scenario: Get request for categories
		Given I make the GET call to the caseservice for categories
		When the response status should be 200
		Then the response should contain a JSON array of size 17
    ...
    And one element of the JSON array must be {"group":null,"name":"COLLECTION_INSTRUMENT_ERROR","longDescription":"Collection Instrument Error","shortDescription":"Collection Instrument Error","role":null}
    ...
    And one element of the JSON array must be {"group":null,"name":"RESPONDENT_EMAIL_AMENDED","longDescription":"Respondent Email Amended","shortDescription":"Respondent Email Amended","role":null}
    ...
    And one element of the JSON array must be {"group":null,"name":"SECURE_MESSAGE_SENT","longDescription":"Secure Message Sent","shortDescription":"Secure Message Sent","role":null}
    ...
    And one element of the JSON array must be {"group":null,"name":"VERIFICATION_CODE_SENT","longDescription":"Verification Code Sent","shortDescription":"Verification Code Sent","role":null}
