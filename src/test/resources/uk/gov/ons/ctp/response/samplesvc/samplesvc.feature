...
Feature: Runs the sample service endpoints
  ...
  Scenario: Post request to sample service for specific survey reference and start time stamp
    Given I make the POST call to the sample service endpoint for surveyRef "221" and for "c6467711-21eb-4e78-804c-1db8392f93fb" with a start of "2017-08-31T23:00:00.000+0000"
