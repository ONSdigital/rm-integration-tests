...
# Keywords Summary : This feature file contains the scenario tests welsh initial online response.
...
@onlineResponse @initialResponse @welshOnlineResponse
Feature: Test successfull Welsh online response
  ...
  Scenario: Clean DB to pre test condition
	...
	Scenario: Get request to case for highest expected case id
		...
		And the response should contain the field "caseTypeId" with an integer value of 8
		And the response should contain the field "actionPlanMappingId" with an integer value of 8
  ...
  Scenario: Test that the case is in a state of Actionable using UI
	...
	Scenario: Test action plan has created online file for printer
		...
		Then get the contents of the file from "/var/actionexporter-sftp/" where the filename begins "ICL2W_2003"
		And the exit status should be 0
		When and each line should start with an iac
		And and the contents should contain "|1000000000000001||||||9 DEE CLOSE|DOTHILL|TELFORD|TF1 3JH"
		And and the contents should contain "|1000000000000008||||||16 DEE CLOSE|DOTHILL|TELFORD|TF1 3JH"
		And and the contents should contain "|1000000000000005|||||BEL AIR|12A DEE CLOSE|DOTHILL|TELFORD|TF1 3JH"
		And and the contents should contain "|1000000000000010||||||18 DEE CLOSE|DOTHILL|TELFORD|TF1 3JH"
		And and the contents should contain "|1000000000000002||||||10 DEE CLOSE|DOTHILL|TELFORD|TF1 3JH"
		And and the contents should contain "|1000000000000009||||||17 DEE CLOSE|DOTHILL|TELFORD|TF1 3JH"
		And and the contents should contain "|1000000000000006||||||14 DEE CLOSE|DOTHILL|TELFORD|TF1 3JH"
		And and the contents should contain "|1000000000000004||||||12 DEE CLOSE|DOTHILL|TELFORD|TF1 3JH"
		And and the contents should contain "|1000000000000007||||||15 DEE CLOSE|DOTHILL|TELFORD|TF1 3JH"
		And and the contents should contain "|1000000000000003||||||11 DEE CLOSE|DOTHILL|TELFORD|TF1 3JH"
