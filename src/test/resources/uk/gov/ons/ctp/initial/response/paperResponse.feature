...
# Keywords Summary : This feature file contains the scenario tests initial paper response.
...
@paperResponse @initialResponse
Feature: Test successfull paper response
