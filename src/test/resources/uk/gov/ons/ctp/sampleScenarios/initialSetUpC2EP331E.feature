...
@sampleScenarios @setUpC2EP331E
Feature: Initial set up C2EP331E
  ...
  Scenario: Clean DB to pre test condition
	...
	Scenario: Test action plan has created paper questionnaire file for printer
		...
		When get the contents of the file from "/var/actionexporter-sftp/" where the filename begins "H1_2003"
		And the exit status should be 0
		Then and each line should start with an iac
		And and the contents should contain "|1000000000000006|||||6 FOLDSTON TERRACE|MAFEKING ROAD|HADLEY|TELFORD|TF1 5LB"
		And and the contents should contain "|1000000000000009||||||2 MARLBOROUGH ROAD|HADLEY|TELFORD|TF1 5LN"
		And and the contents should contain "|1000000000000002|||||2 FOLDSTON TERRACE|MAFEKING ROAD|HADLEY|TELFORD|TF1 5LB"
		And and the contents should contain "|1000000000000005|||||5 FOLDSTON TERRACE|MAFEKING ROAD|HADLEY|TELFORD|TF1 5LB"
		And and the contents should contain "|1000000000000010||||||4 MARLBOROUGH ROAD|HADLEY|TELFORD|TF1 5LN"
		And and the contents should contain "|1000000000000001|||||1 FOLDSTON TERRACE|MAFEKING ROAD|HADLEY|TELFORD|TF1 5LB"
		And and the contents should contain "|1000000000000008||||||1 MARLBOROUGH ROAD|HADLEY|TELFORD|TF1 5LN"
		And and the contents should contain "|1000000000000003|||||3 FOLDSTON TERRACE|MAFEKING ROAD|HADLEY|TELFORD|TF1 5LB"
		And and the contents should contain "|1000000000000004|||||4 FOLDSTON TERRACE|MAFEKING ROAD|HADLEY|TELFORD|TF1 5LB"
		And and the contents should contain "|1000000000000007||||||26A MAFEKING ROAD|HADLEY|TELFORD|TF1 5LB"
