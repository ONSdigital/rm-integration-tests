...
# Keywords Summary : This feature file contains the scenario tests the field visits where nor reponse is expected.
...
@refusal @field
Feature: Test successfull refusals from field visit
  ...
  Scenario: Clean DB to pre test condition
	...
	Scenario: Post request to actionplans to create jobs for specified action plan - reminder letter 1
		Given the case start date is adjusted to trigger action plan
			...
			| 1  						| 5   				 | 10		 |
		And after a delay of 180 seconds
